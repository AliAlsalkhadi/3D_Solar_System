...
/**
 * This class is responsible for sounds of the other class and their objects
...
public class SoundUtilityJOAL {
	...
	/**
	 * A method to set up the link to OpenAL (OpenAL Utility Toolkit) via JOAL
	 */
	...
	/**
	 * A method to position the listener at (0, 0, 0) facing towards (0, 0, -1)
	 */
...
// --------------- source methods -----------------------------
	...
	/**
	 * A method to load sound as a buffer and use it to initialize OpenAL source
	 * @param nm
	 * @param toLoop
	...
	/**
	 * A method function to create a buffer for the named (without ".wav") sound 
	 * @param nm
	 * @return a buffer
	 */
	...
	/**
	 * A method to use the sound buffer to initialize a sound source at (0,0,0)
	 * with no velocity. he sound may play looping, depending on 'toLoop'.
	 * @param nm
	 * @param buf
	 * @param toLoop
	...
	/**
	 * A method to move the sound named 'nm' to position at (x,y,z)
	 * @param nm
	 * @param x
	 * @param y
	 * @param z
	...
	/**
	 * A method to play or resume the sound named 'nm'
	 * @param nm
	 * @return true or false
	 */
	...
	/**
	 * A method to stop the playing of the sound named 'nm'
	 * @param nm
	 * @return true or false
	 */
	...
	/**
	 * A method to pause the playing of the sound named 'nm'
	 * @param nm
	 * @return true or false
	 */
...
// --------------------- listener methods ---------------------
	...
	/**
	 * A method to move the listener by (x,z) step (y is always 0, on the floor) 
	 * @param xStep
	 * @param zStep
	 */
	...
	/**
	 * A method function to position the listener at (xNew,zNew) (y is always 0, on the floor)
	 * @param xNew
	 * @param zNew
	 */
	...
	/**
	 * A method to turn the listener anti-clockwise by degrees 
	 * @param degrees
	 */
	...
	/**
	 * A method to set the listener's orientation to 'ang' degrees (in the
	 * anti-clockwise direction around the y-axis)
	 * @param ang
	 */
...
// -------------------------- finish --------------------------
	...
	/**
	 * A method to delete all the source and buffers in the hash maps
	 */
	public void cleanUp() {
